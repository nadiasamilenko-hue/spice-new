...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Spice Market — Преміальні спеції" },
      { name: "twitter:description", content: "Чисті спеції, суміші, чаї та подарункові набори." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "Spice Market",
          description: "Преміальні спеції, авторські суміші та чаї.",
          areaServed: "UA",
        }),
      },
    ],
