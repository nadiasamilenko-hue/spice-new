  ...
  if (lines.length === 0) {
    return (
      <div className="container mx-auto px-4 py-24 text-center">
        ...
        <Link
          to="/shop"
          className="mt-8 inline-flex items-center gap-2 rounded-sm bg-accent px-6 py-3 text-sm font-medium text-accent-foreground hover:bg-accent/90"
        >
    ...
    <div className="container mx-auto grid gap-10 px-4 py-12 lg:grid-cols-[1fr_360px]">
      <div>
        ...
        <p className="text-sm text-muted-foreground mb-8">
          {totalItems} {totalItems === 1 ? "позиція" : "позицій"}
        </p>
      ...
      <aside className="h-fit rounded-sm border border-border bg-card p-6 lg:sticky lg:top-32">
        ...
        <Link
          to="/checkout"
          className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-sm bg-accent py-4 text-sm font-medium text-accent-foreground hover:bg-accent/90"
        >
